...
OhdsiRTools::checkUsagePackage("obesityanalysis")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/obesityanalysis.pdf")
shell("R CMD Rd2pdf ./ --output=extras/obesityanalysis.pdf")
...
OhdsiRTools::createRenvLockFile("obesityanalysis")
